...
"""
Possible CGI entry point for the SDE package.
...
def brett_test(uri) :
	def err_message(msg) :
		...
		print("<html>")
		print("<head>")
		print("<title>Error in SDE processing</title>")
		print("</head><body>")
		print("<h1>Error in distilling SDE</h1>")
		print("<p>")
		clean_print("SDE cannot process this URI: %s", uri)
		print("</p>")
		if len(msg) != 0:
			print("<p>")
			clean_print(msg)
...
if uri == "referer" :
	...
	if uri is None:
		...
		brett_test(uri)
		newuri = "http://www.w3.org/2012/sde/extract?uri=" + uri
